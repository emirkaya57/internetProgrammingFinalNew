...
<html lang="en">
	...
	<body>
		...
		<div id="page" class="page">
				 	...
				 	<!-- NAVIGATION MENU -->
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<!-- HEADER LOGO -->
	    					<div class="desktoplogo"><a href="index.php" class="logo-black"><img src="images/logo-01.png" alt="header-logo"></a></div>
	    					<div class="desktoplogo"><a href="index.php" class="logo-white"><img src="images/logo-white.png" alt="header-logo"></a></div>
	    					...
	    					<!-- MAIN MENU -->
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list nav-skyblue-hover">
							    	...
							    	<li class="nl-simple" aria-haspopup="true"><a href="takim-detay.php?takim_id=1">Erkek Voleybol Takımı</a></li>




							    	<!-- SIMPLE NAVIGATION LINK --> 
							    	<li class="nl-simple" aria-haspopup="true"><a href="takim-detay.php?takim_id=2">Kadın Voleybol Takımı</a></li>
			...
			<!-- HERO-2
			============================================= -->	
			<section id="hero-2" class="hero-section division" style="background: url('https://iaftm.tmgrup.com.tr/3caea0/1200/627/0/151/1200/778?u=https://iftm.tmgrup.com.tr/2021/03/23/son-dakika-spor-haberleri-galatasaray-kadin-voleybol-takimi-cev-kupasinda-ikinci-oldu-1616526836762.jpeg'); background-repeat:no-repeat; background-size:cover; background-position:center; height:100vh">
